...
def combine_mask():
    ...
    segmentation_dir = os.path.join(script_dir, 'MRI_data', 's0001', 'segmentations')
    combined_scan_pattern = os.path.join(script_dir, 'MRI_data', 's*', '*', 'combined*')
    folders_pattern = os.path.join(script_dir, 'MRI_data', 's*', 'se*')
